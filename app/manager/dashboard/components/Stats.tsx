...
interface PaymentData { amount: number; status: string; }
interface ExpenseData { amount: number; date: string; }
...
export default function Stats({ lang, month, year }: StatsProps) {
  ...
  return (
    <div id="stats-section" className="grid grid-cols-1 md:grid-cols-3 gap-6 no-print">
